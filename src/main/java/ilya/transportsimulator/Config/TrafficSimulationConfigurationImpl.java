package ilya.transportsimulator.Config;

import ilya.transportsimulator.Geometry.Line2D;
import ilya.transportsimulator.Geometry.Point2D;
import ilya.transportsimulator.RoadEquipment.*;
...
public class TrafficSimulationConfigurationImpl implements TrafficSimulationConfiguration {
    ...
    private void initialize(final TrafficSimulation simulation) {
        simulation.setPreferredRoadUsersCount(1_000);
        simulation.setMaxRoadUsersCount(2_000);
