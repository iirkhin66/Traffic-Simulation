package ilya.transportsimulator.Controller;

import ilya.transportsimulator.App.TrafficSimulationApplication;
import ilya.transportsimulator.Config.TrafficSimulationConfigurationImpl;
import ilya.transportsimulator.Graphics.TrafficSimulationGraphics;
import ilya.transportsimulator.Graphics.TrafficSimulationGraphicsImpl;
import ilya.transportsimulator.RoadUsers.TCar;
import ilya.transportsimulator.RoadUsers.TPedestrian;
import ilya.transportsimulator.RoadUsers.TTruck;
import ilya.transportsimulator.Simulation.TrafficSimulation;
