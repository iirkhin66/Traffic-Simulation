package ilya.transportsimulator.App;

import ilya.transportsimulator.Controller.TrafficSimulationController;
...
public class TrafficSimulationApplication extends Application {
    ...
    public void start(final Stage stage) throws IOException {
        final FXMLLoader loader = new FXMLLoader(getClass().getResource("/ilya/transportsimulator/UI/window.fxml"));
