package ilya.transportsimulator.Graphics;
...
import ilya.transportsimulator.RoadUsers.*;
...
public final class TrafficSimulationGraphicsImpl extends TrafficSimulationGraphics {
    ...
    private static final boolean LOG_VELOCITY_INFO = true;
    private static final boolean LOG_MAX_VELOCITY_INFO = true;
    private static final boolean LOG_POSITION_INFO = true;
    ...
    protected void renderSimulationFrame() {
        ...
        //System.out.println("RENDERING SIMULATION FRAME!!!");
    }
